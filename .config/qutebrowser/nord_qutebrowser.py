...
nord = {
    ...
    'hintfont': '#1b1e26',
    'tabselected': '#000511',
    'compheader': 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #3b4252, stop:1 #2e3440)',
    'nord1': '#2e3440'
}

## Background color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.bg = nord['compheader']
...
## Type: QssColor
c.colors.completion.even.bg = nord['base03']
...
## Type: QtColor
c.colors.completion.item.selected.fg = nord['nord1']

## Foreground color of the matched text in the completion.
## Type: QssColor
c.colors.completion.match.fg = nord['nord11']
...
## Type: QssColor
c.colors.hints.fg = nord['hintfont']

## Font color for the matched part of hints.
## Type: QssColor
c.colors.hints.match.fg = nord['hintmatch']
...
## Type: QtColor
c.colors.tabs.odd.bg = nord['base0']
...
## Type: QtColor
c.colors.tabs.selected.even.bg = nord['tabselected']
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['tabselected']
